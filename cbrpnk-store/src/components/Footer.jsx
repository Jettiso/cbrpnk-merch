...
const Footer = () => {
	...
	return (
		<>
			<footer className='mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto  dark:bg-gray-800'>
				<div className='text-center'>
					...
					<div className='mt-3'>
						<p className='text-gray-500'>
							We're an independent company that specializes in providing the best Cyberpunk merch
						</p>
						<p className='text-gray-500'>©CBRPNK merch {year}. All rights reserved.</p>
					</div>
